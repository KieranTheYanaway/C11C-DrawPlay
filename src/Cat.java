...
public class Cat {
	...
	private static final int EYE_WIDTH1 = 10;
	private static final int EYE_WIDTH2 = 20;
	...
	public void draw(Graphics g, int catX, int catY)
	{
		...
		x = catX + EYE_X; 
		y = catY + EYE_Y;
		g2.fillOval(x, y, EYE_WIDTH2, EYE_HEIGHT);
		g2.setColor(Color.black);
		g2.fillOval(x+5, y, EYE_WIDTH1, EYE_HEIGHT);
		x += EYE_SEPARATION;
		g2.setColor(Color.green);
		g2.fillOval(x, y, EYE_WIDTH2, EYE_HEIGHT);
		g2.setColor(Color.black);
